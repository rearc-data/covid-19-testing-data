		...
		Details={
			'ImportAssetsFromS3': {
				...
				'AssetSources': [
					{
						'Bucket': s3_bucket,
						'Key': new_s3_key + 'states.csv'
					},
					{
						'Bucket': s3_bucket,
						'Key': new_s3_key + 'states_daily.csv'
					},
					{
						'Bucket': s3_bucket,
						'Key': new_s3_key + 'states_info.csv'
					},
					{
						'Bucket': s3_bucket,
						'Key': new_s3_key + 'us.csv'
					},
					{
						'Bucket': s3_bucket,
						'Key': new_s3_key + 'us_daily.csv'
					},
					{
						'Bucket': s3_bucket,
						'Key': new_s3_key + 'counties.csv'
					}
				]
			}
		}
